/**
 * Footer optimisé avec les nouveaux stores
 */
"use client"
    ...
    <footer className="bg-primary text-primary-foreground">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="flex flex-col items-center text-center gap-2">
              ...
              <p className="text-xs text-primary-foreground/60">
                Dès {siteConfig.shipping.freeThreshold}€ d'achat
              </p>
            </div>
            <div className="flex flex-col items-center text-center gap-2">
      ...
      <div className="mx-auto max-w-7xl px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {/* Brand */}
          <div>
            <h3 className="font-serif text-xl tracking-widest font-bold mb-4">{siteConfig.name}</h3>
      ...
      <div className="border-t border-primary-foreground/10">
        <div className="mx-auto max-w-7xl px-4 py-4 text-center text-xs text-primary-foreground/50">
          &copy; {new Date().getFullYear()} {siteConfig.name} Paris. Tous droits réservés.
        </div>
      </div>
    </footer>
  )
