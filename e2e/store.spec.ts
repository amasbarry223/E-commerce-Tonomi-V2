...
const ADMIN_EMAIL =
  ...
  process.env.NEXT_PUBLIC_ADMIN_DEFAULT_EMAIL ||
  "admin@tonomi.com"
const ADMIN_PASSWORD =
  process.env.PLAYWRIGHT_ADMIN_PASSWORD ||
  process.env.NEXT_PUBLIC_ADMIN_DEFAULT_PASSWORD ||
  "admin123"
...
test.describe("Boutique (authentifié)", () => {
  ...
  test("panier accessible via la SPA", async ({ page }) => {
    // La boutique est une SPA sur / — le panier se navigue via l'état interne
    await page.goto("/")
