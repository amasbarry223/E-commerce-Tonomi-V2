        ...
        {product.stock > 0 ? (
          <>
            <div className="flex flex-col gap-1">
              ...
              {product.stock > 0 && (
                <p className="text-xs text-muted-foreground">Stock restant : {product.stock}</p>
              )}
            </div>
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-xs text-muted-foreground">Ce produit est actuellement indisponible.</p>
            <Button
              variant="outline"
              size="sm"
              className="w-fit"
              onClick={() => {
                toast.info("En production, vous seriez notifié quand ce produit serait de nouveau disponible.")
              }}
              aria-label="Être notifié du réapprovisionnement"
            >
