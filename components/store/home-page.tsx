    ...
    <div>
      ...
      <section className="relative h-[60vh] md:h-[70vh] overflow-hidden">
        {heroSlides.map((slide, index) => (
          ...
          >
            <img src={slide.image} alt={slide.title} className="h-full w-full object-cover" crossOrigin="anonymous" />
            <div className="absolute inset-0 bg-gradient-to-r from-black/60 via-black/30 to-transparent" />
            <div className="absolute inset-0 flex items-center">
              <div className="mx-auto max-w-7xl px-4 w-full">
                <div className="max-w-lg">
                  <h1 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white font-bold mb-4 text-balance leading-tight">{slide.title}</h1>
